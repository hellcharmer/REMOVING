            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                joinerImg.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent1 = new Intent(ExeInfoparticipate.this, Homepage.class);
                ...
                builder.setPositiveButton(
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(
                                ...
                                ExeSharedMthd.cancelRequest(exerciseId, MainActivity.getUser().getUseraccount(),ExeInfoparticipate.this);
                                finish();
                            }
                        });
